...
const experiences = [
  ...
  },
  {
    ...
    position: "Fulltime Remote/Hybrid - Frontend Developer",
    color: "#E6AB35",
    description:
  ...
  },
  {
    ...
    color: "#F26440",
    description:
      "As the fullstack position at this company, my responsibilities span both the backend and frontend even server, along with providing IT support. I utilize PHP and jQuery to successfully complete our projects, taking charge of various tasks across the entire development spectrum.",
  },
];
